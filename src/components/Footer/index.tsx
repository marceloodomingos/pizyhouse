...
import { FooterContainer, BottomContent } from "./styles";
        ...
        <div className="navbar">
          <div>
            ...
            <ul>
              ...
              <li>
                <Link href="/policies">Política de Cookies</Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul>
              ...
              <li>
                <Link href="/dashboard/profile">Informações da conta</Link>
              </li>
              <li>
                <Link href="/signin">Acesso à conta</Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul>
              ...
              <li>
                <Link href="/topday">Criptomoedas</Link>
              </li>
              <li>
                <Link href="/nfts">NFTs</Link>
              </li>
              <li>
                <Link href="/about-market">Mercado</Link>
              </li>
            </ul>
          </div>
          <div>
            ...
            <ul>
              <li>
                <Link href="/our-team">Equipe</Link>
              </li>
              <li>
                <Link href="/docs#used-techs">Tecnologias</Link>
              </li>
              <li>
                <Link href="/docs#credits">Creditos</Link>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="container">
          ...
          <div className="follow-us">
            ...
            <div className="social">
              <a target="_blank" href="https://instagram.com/pizyhouse">
                <svg
                  role="img"
                  viewBox="0 0 24 24"
              ...
              <a target="_blank" href="https://twitter.com/pizyhouse">
                <svg
                  role="img"
                  viewBox="0 0 24 24"
                  xmlns="http://www.w3.org/2000/svg"
