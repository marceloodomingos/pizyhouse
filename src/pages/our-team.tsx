...
import { TeamMember, TeamWrapper } from "~/styles/pages/ourteam";
      ...
      <main>
        ...
        <TeamWrapper>
          <TeamMember>
            ...
            <div className="social">
              <a target="_blank" href="https://instagram.com/marceloodomingos">
                <svg
                  role="img"
                  viewBox="0 0 24 24"
              ...
              <a target="_blank" href="https://twitter.com/marceload_">
                <svg
                  role="img"
                  viewBox="0 0 24 24"
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <a target="_blank" href="https://github.com/gelzinn">
                <svg
                  role="img"
                  viewBox="0 0 24 24"
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <a target="_blank" href="https://gelzin.com/">
                <Globe />
              </a>
            </div>
          ...
          <TeamMember>
            <div className="info">
              <img
                src="https://raw.githubusercontent.com/gelzinn/ph-assets/main/team/daniel.jpg"
                alt="Daniel Lima de Souza"
              />
              <span>Daniel Lima de Souza</span>
            </div>
            <p>Me Acompanhe</p>
            <div className="social">
              <a target="_blank" href="https://instagram.com/daniells.png">
                <svg
                  role="img"
                  viewBox="0 0 24 24"
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <a target="_blank" href="https://twitter.com/danielsann0">
                <svg
                  role="img"
                  viewBox="0 0 24 24"
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <a target="_blank" href="https://github.com/DanielsPng">
                <svg
                  role="img"
                  viewBox="0 0 24 24"
                  xmlns="http://www.w3.org/2000/svg"
        ...
        <TeamWrapper>
          <TeamMember>
            ...
            <footer>Chief Marketing Officer</footer>
          </TeamMember>
          <TeamMember>
            <div className="info">
              <img
                src="https://scontent.fbau3-2.fna.fbcdn.net/v/t39.30808-6/279114781_1925238544337832_2606718771378387631_n.jpg?_nc_cat=107&ccb=1-7&_nc_sid=09cbfe&_nc_eui2=AeGIGNG240Qig9IqtXJH-mJn7uJqnYbjtxLu4mqdhuO3EnJ-lxCrXP19lTCSq2SH0DruaHM1MpTji3mYAvqH_8Ce&_nc_ohc=4icgR_lhsAgAX_aKJcY&_nc_ht=scontent.fbau3-2.fna&oh=00_AT-sadfsDwH6qm-D4LvMCfd23cHQ0NHkJqRqvKrvEOdJKg&oe=629F2372"
                alt="Marcelo Augusto Domingos"
              />
              <span>Luan Daniel da Silva Fabri</span>
            </div>
            <div className="social">
              <a target="_blank" href="https://instagram.com/luan_fabrii">
                <svg
                  role="img"
                  viewBox="0 0 24 24"
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <footer>Web Content Executive</footer>
          </TeamMember>
          <TeamMember>
            <div className="info">
              <img
                src="https://scontent.fbau3-2.fna.fbcdn.net/v/t1.6435-9/71182376_804345259962665_7339978136815140864_n.jpg?_nc_cat=107&ccb=1-7&_nc_sid=174925&_nc_eui2=AeEUt4xjD623CPGu4FDefdBKTsbU7xFlOsJOxtTvEWU6wi9GhJSKyUOnrpbmqLnLgg2gGTlxjFdAMgalhtP7tVyF&_nc_ohc=xdkn-ZuHRjAAX_NdR8C&_nc_ht=scontent.fbau3-2.fna&oh=00_AT-Kc43mN7_wuurxAILo8xvMO1PvTfnPuFCVm3jFD7YdwA&oe=62C00B84"
                alt="Marcelo Augusto Domingos"
              />
              <span>Fabrício Silva Cabral</span>
            </div>
            <div className="social">
              <a target="_blank" href="https://instagram.com/fabricio.mdt">
                <svg
                  role="img"
                  viewBox="0 0 24 24"
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <footer>Chief Quality Control Officer</footer>
          </TeamMember>
        </TeamWrapper>
      </main>
      <Footer />
